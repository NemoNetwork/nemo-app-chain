...
export interface Msg {
  ...
  updateMegavaultParams(request: MsgUpdateMegavaultParams): Promise<MsgUpdateMegavaultParamsResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.updateMegavaultParams = this.updateMegavaultParams.bind(this);
  ...
  withdrawFromMegavault(request: MsgWithdrawFromMegavault): Promise<MsgWithdrawFromMegavaultResponse> {
    ...
    const promise = this.rpc.request("nemo_network.vault.Msg", "WithdrawFromMegavault", data);
  ...
  updateOperatorParams(request: MsgUpdateOperatorParams): Promise<MsgUpdateOperatorParamsResponse> {
    ...
    const promise = this.rpc.request("nemo_network.vault.Msg", "UpdateOperatorParams", data);
    return promise.then(data => MsgUpdateOperatorParamsResponse.decode(new _m0.Reader(data)));
  }

  updateMegavaultParams(request: MsgUpdateMegavaultParams): Promise<MsgUpdateMegavaultParamsResponse> {
    const data = MsgUpdateMegavaultParams.encode(request).finish();
    const promise = this.rpc.request("nemo_network.vault.Msg", "UpdateMegavaultParams", data);
    return promise.then(data => MsgUpdateMegavaultParamsResponse.decode(new _m0.Reader(data)));
  }
  ...
  unlockShares(request: MsgUnlockShares): Promise<MsgUnlockSharesResponse> {
    ...
    const promise = this.rpc.request("nemo_network.vault.Msg", "UnlockShares", data);
  ...
  allocateToVault(request: MsgAllocateToVault): Promise<MsgAllocateToVaultResponse> {
    ...
    const promise = this.rpc.request("nemo_network.vault.Msg", "AllocateToVault", data);
  ...
  retrieveFromVault(request: MsgRetrieveFromVault): Promise<MsgRetrieveFromVaultResponse> {
    ...
    const promise = this.rpc.request("nemo_network.vault.Msg", "RetrieveFromVault", data);
