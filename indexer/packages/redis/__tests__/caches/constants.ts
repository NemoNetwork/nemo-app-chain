import { IsoString, OrderTable, SubaccountTable } from '@nemo-network-indexer/postgres';
import { ORDER_FLAG_LONG_TERM, ORDER_FLAG_SHORT_TERM } from '@nemo-network-indexer/v4-proto-parser';
import {
  IndexerOrder,
  IndexerOrder_Side,
...
export const address: string = 'nemo-network174e000tqwvszgjxs7yaj844e0m9s6f0m45ws7q';
