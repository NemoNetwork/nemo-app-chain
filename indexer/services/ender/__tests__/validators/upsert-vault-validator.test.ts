import { ParseMessageError, logger } from '@nemo-network-indexer/base/build';
import {
...
import { dbHelpers, testConstants, testMocks } from '@nemo-network-indexer/postgres';
...
describe('upsert-vault-validator', () => {
  ...
  describe('validate', () => {
    it('does not throw error on valid upsert vault event', () => {
