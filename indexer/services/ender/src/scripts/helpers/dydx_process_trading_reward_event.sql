...
/**
  Parameters:
    - trading_reward: the trading reward to process, which should match AddressTradingReward (proto/nemo-network/indexer/events/events.proto#AddressTradingReward).
