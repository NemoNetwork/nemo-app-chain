...
/**
  Parameters:
    ...
    - event_data: The 'data' field of the IndexerTendermintEvent (https://github.com/nemo-network/v4-chain/blob/main/proto/nemo_network/indexer/indexer_manager/event.proto#L25)
