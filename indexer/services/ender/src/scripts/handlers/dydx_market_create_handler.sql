...
/**
  ...
  Returns: JSON object containing fields:
    - market: The created market in market-model format (https://github.com/nemo-network/v4-chain/blob/9ed26bd/indexer/packages/postgres/src/models/market-model.ts).
