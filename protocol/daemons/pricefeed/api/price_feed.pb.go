...
// source: nemo_network/daemons/pricefeed/price_feed.proto
...
func (*UpdateMarketPricesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_96c4b4d57161bd40, []int{0}
}
...
func (*UpdateMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_96c4b4d57161bd40, []int{1}
}
...
func (*ExchangePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_96c4b4d57161bd40, []int{2}
}
...
func (*MarketPriceUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_96c4b4d57161bd40, []int{3}
}
...
func init() {
	proto.RegisterFile("nemo_network/daemons/pricefeed/price_feed.proto", fileDescriptor_96c4b4d57161bd40)
}

var fileDescriptor_96c4b4d57161bd40 = []byte{
	// 444 bytes of a gzipped FileDescriptorProto
	,
}
