...
// source: nemo_network/clob/clob_pair.proto
...
func (ClobPair_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5ceab4b8f5011786, []int{2, 0}
}
...
func (*PerpetualClobMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ceab4b8f5011786, []int{0}
}
...
func (*SpotClobMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ceab4b8f5011786, []int{1}
}
...
func (*ClobPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ceab4b8f5011786, []int{2}
}
...
func init() { proto.RegisterFile("nemo_network/clob/clob_pair.proto", fileDescriptor_5ceab4b8f5011786) }

var fileDescriptor_5ceab4b8f5011786 = []byte{
	...
	,
}
