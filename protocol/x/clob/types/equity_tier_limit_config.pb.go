...
// source: nemo-network/clob/equity_tier_limit_config.proto
...
type EquityTierLimit struct {
	...
	UsdTncRequired github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,1,opt,name=usd_tnc_required,json=usdTncRequired,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"usd_tnc_required"`
