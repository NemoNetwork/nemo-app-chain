...
// source: nemo_network/clob/mev.proto
...
func (*MEVMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_b31279e9fbf4a1e2, []int{0}
}
...
func (*MEVLiquidationMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_b31279e9fbf4a1e2, []int{1}
}
...
func (*ClobMidPrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_b31279e9fbf4a1e2, []int{2}
}
...
func (*ValidatorMevMatches) Descriptor() ([]byte, []int) {
	return fileDescriptor_b31279e9fbf4a1e2, []int{3}
}
...
func (*MevNodeToNodeMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_b31279e9fbf4a1e2, []int{4}
}
...
func init() { proto.RegisterFile("nemo_network/clob/mev.proto", fileDescriptor_b31279e9fbf4a1e2) }

var fileDescriptor_b31279e9fbf4a1e2 = []byte{
	// 703 bytes of a gzipped FileDescriptorProto
	,
}
