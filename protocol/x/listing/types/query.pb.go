...
// source: nemo-network/listing/query.proto
...
func init() {
	proto.RegisterType((*QueryMarketsHardCap)(nil), "nemo-network.listing.QueryMarketsHardCap")
	proto.RegisterType((*QueryMarketsHardCapResponse)(nil), "nemo-network.listing.QueryMarketsHardCapResponse")
	proto.RegisterType((*QueryListingVaultDepositParams)(nil), "nemo-network.listing.QueryListingVaultDepositParams")
	proto.RegisterType((*QueryListingVaultDepositParamsResponse)(nil), "nemo-network.listing.QueryListingVaultDepositParamsResponse")
}

func init() { proto.RegisterFile("nemo-network/listing/query.proto", fileDescriptor_6c3602ac8eedf7cc) }
...
func (c *queryClient) MarketsHardCap(ctx context.Context, in *QueryMarketsHardCap, opts ...grpc.CallOption) (*QueryMarketsHardCapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.listing.Query/MarketsHardCap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListingVaultDepositParams(ctx context.Context, in *QueryListingVaultDepositParams, opts ...grpc.CallOption) (*QueryListingVaultDepositParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.listing.Query/ListingVaultDepositParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_MarketsHardCap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.listing.Query/MarketsHardCap",
	}
...
func _Query_ListingVaultDepositParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.listing.Query/ListingVaultDepositParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nemo-network.listing.Query",
	...
	Metadata: "nemo-network/listing/query.proto",
}
