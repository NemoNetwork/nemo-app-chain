...
// source: nemo-network/listing/tx.proto
...
func init() {
	proto.RegisterType((*MsgSetMarketsHardCap)(nil), "nemo-network.listing.MsgSetMarketsHardCap")
	proto.RegisterType((*MsgSetMarketsHardCapResponse)(nil), "nemo-network.listing.MsgSetMarketsHardCapResponse")
	proto.RegisterType((*MsgCreateMarketPermissionless)(nil), "nemo-network.listing.MsgCreateMarketPermissionless")
	proto.RegisterType((*MsgCreateMarketPermissionlessResponse)(nil), "nemo-network.listing.MsgCreateMarketPermissionlessResponse")
	proto.RegisterType((*MsgSetListingVaultDepositParams)(nil), "nemo-network.listing.MsgSetListingVaultDepositParams")
	proto.RegisterType((*MsgSetListingVaultDepositParamsResponse)(nil), "nemo-network.listing.MsgSetListingVaultDepositParamsResponse")
}

func init() { proto.RegisterFile("nemo-network/listing/tx.proto", fileDescriptor_144a579c1e2dcb94) }
...
func (c *msgClient) SetMarketsHardCap(ctx context.Context, in *MsgSetMarketsHardCap, opts ...grpc.CallOption) (*MsgSetMarketsHardCapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.listing.Msg/SetMarketsHardCap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateMarketPermissionless(ctx context.Context, in *MsgCreateMarketPermissionless, opts ...grpc.CallOption) (*MsgCreateMarketPermissionlessResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.listing.Msg/CreateMarketPermissionless", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetListingVaultDepositParams(ctx context.Context, in *MsgSetListingVaultDepositParams, opts ...grpc.CallOption) (*MsgSetListingVaultDepositParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.listing.Msg/SetListingVaultDepositParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetMarketsHardCap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.listing.Msg/SetMarketsHardCap",
	}
...
func _Msg_CreateMarketPermissionless_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.listing.Msg/CreateMarketPermissionless",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SetListingVaultDepositParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.listing.Msg/SetListingVaultDepositParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nemo-network.listing.Msg",
	...
	Metadata: "nemo-network/listing/tx.proto",
}
