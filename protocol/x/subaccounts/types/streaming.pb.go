...
// source: nemo-network/subaccounts/streaming.proto
...
func init() {
	proto.RegisterType((*StreamSubaccountUpdate)(nil), "nemo-network.subaccounts.StreamSubaccountUpdate")
	proto.RegisterType((*SubaccountPerpetualPosition)(nil), "nemo-network.subaccounts.SubaccountPerpetualPosition")
	proto.RegisterType((*SubaccountAssetPosition)(nil), "nemo-network.subaccounts.SubaccountAssetPosition")
}

func init() {
	proto.RegisterFile("nemo-network/subaccounts/streaming.proto", fileDescriptor_e6cf3092946c3c13)
}
