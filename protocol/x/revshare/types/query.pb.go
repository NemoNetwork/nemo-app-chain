...
// source: nemo-network/revshare/query.proto
...
func init() {
	proto.RegisterType((*QueryMarketMapperRevenueShareParams)(nil), "nemo-network.revshare.QueryMarketMapperRevenueShareParams")
	proto.RegisterType((*QueryMarketMapperRevenueShareParamsResponse)(nil), "nemo-network.revshare.QueryMarketMapperRevenueShareParamsResponse")
	proto.RegisterType((*QueryMarketMapperRevShareDetails)(nil), "nemo-network.revshare.QueryMarketMapperRevShareDetails")
	proto.RegisterType((*QueryMarketMapperRevShareDetailsResponse)(nil), "nemo-network.revshare.QueryMarketMapperRevShareDetailsResponse")
}

func init() { proto.RegisterFile("nemo-network/revshare/query.proto", fileDescriptor_13d50c6e3048e744) }
...
func (c *queryClient) MarketMapperRevenueShareParams(ctx context.Context, in *QueryMarketMapperRevenueShareParams, opts ...grpc.CallOption) (*QueryMarketMapperRevenueShareParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.revshare.Query/MarketMapperRevenueShareParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) MarketMapperRevShareDetails(ctx context.Context, in *QueryMarketMapperRevShareDetails, opts ...grpc.CallOption) (*QueryMarketMapperRevShareDetailsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.revshare.Query/MarketMapperRevShareDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_MarketMapperRevenueShareParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.revshare.Query/MarketMapperRevenueShareParams",
	}
...
func _Query_MarketMapperRevShareDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.revshare.Query/MarketMapperRevShareDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nemo-network.revshare.Query",
	...
	Metadata: "nemo-network/revshare/query.proto",
}
