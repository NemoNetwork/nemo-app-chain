...
// source: nemo-network/revshare/tx.proto
...
func init() {
	proto.RegisterType((*MsgSetMarketMapperRevenueShare)(nil), "nemo-network.revshare.MsgSetMarketMapperRevenueShare")
	proto.RegisterType((*MsgSetMarketMapperRevenueShareResponse)(nil), "nemo-network.revshare.MsgSetMarketMapperRevenueShareResponse")
	proto.RegisterType((*MsgSetMarketMapperRevShareDetailsForMarket)(nil), "nemo-network.revshare.MsgSetMarketMapperRevShareDetailsForMarket")
	proto.RegisterType((*MsgSetMarketMapperRevShareDetailsForMarketResponse)(nil), "nemo-network.revshare.MsgSetMarketMapperRevShareDetailsForMarketResponse")
}

func init() { proto.RegisterFile("nemo-network/revshare/tx.proto", fileDescriptor_460d8062a262197e) }
...
func (c *msgClient) SetMarketMapperRevenueShare(ctx context.Context, in *MsgSetMarketMapperRevenueShare, opts ...grpc.CallOption) (*MsgSetMarketMapperRevenueShareResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.revshare.Msg/SetMarketMapperRevenueShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetMarketMapperRevShareDetailsForMarket(ctx context.Context, in *MsgSetMarketMapperRevShareDetailsForMarket, opts ...grpc.CallOption) (*MsgSetMarketMapperRevShareDetailsForMarketResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.revshare.Msg/SetMarketMapperRevShareDetailsForMarket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetMarketMapperRevenueShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.revshare.Msg/SetMarketMapperRevenueShare",
	}
...
func _Msg_SetMarketMapperRevShareDetailsForMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.revshare.Msg/SetMarketMapperRevShareDetailsForMarket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nemo-network.revshare.Msg",
	...
	Metadata: "nemo-network/revshare/tx.proto",
}
