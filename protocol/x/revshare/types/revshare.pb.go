...
// source: nemo-network/revshare/revshare.proto
...
func init() {
	proto.RegisterType((*MarketMapperRevShareDetails)(nil), "nemo-network.revshare.MarketMapperRevShareDetails")
}

func init() {
	proto.RegisterFile("nemo-network/revshare/revshare.proto", fileDescriptor_5b9759663d195798)
}
