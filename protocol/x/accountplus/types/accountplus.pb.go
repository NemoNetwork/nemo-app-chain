...
// source: nemo-network/accountplus/accountplus.proto
...
func init() {
	proto.RegisterType((*AccountState)(nil), "nemo-network.accountplus.AccountState")
	proto.RegisterType((*TimestampNonceDetails)(nil), "nemo-network.accountplus.TimestampNonceDetails")
}

func init() {
	proto.RegisterFile("nemo-network/accountplus/accountplus.proto", fileDescriptor_391b06af1cfe6fb0)
}
