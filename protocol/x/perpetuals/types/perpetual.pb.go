...
// source: nemo_network/perpetuals/perpetual.proto
...
func (PerpetualMarketType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_538dbb63354c4085, []int{0}
}
...
type Perpetual struct {
	...
	FundingIndex github_com_nemo_network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"funding_index"`
	// Total size of open long contracts, measured in base_quantums.
	OpenInterest github_com_nemo_network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=open_interest,json=openInterest,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"open_interest"`
}
...
func (*PerpetualParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_538dbb63354c4085, []int{1}
}
...
func (*MarketPremiums) Descriptor() ([]byte, []int) {
	return fileDescriptor_538dbb63354c4085, []int{2}
}
...
func (*PremiumStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_538dbb63354c4085, []int{3}
}
...
func (*LiquidityTier) Descriptor() ([]byte, []int) {
	return fileDescriptor_538dbb63354c4085, []int{4}
}
...
func init() {
	proto.RegisterFile("nemo_network/perpetuals/perpetual.proto", fileDescriptor_538dbb63354c4085)
}

var fileDescriptor_538dbb63354c4085 = []byte{
	// 769 bytes of a gzipped FileDescriptorProto
	,
}
