...
func init() {
	proto.RegisterType((*BridgeEventInfo)(nil), "nemo-network.bridge.BridgeEventInfo")
}

func init() {
	proto.RegisterFile("nemo-network/bridge/bridge_event_info.proto", fileDescriptor_ca20c815789f7707)
}
