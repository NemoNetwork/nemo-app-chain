...
// source: nemo_network/bridge/params.proto
...
func (*EventParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a266eca16a42cbe, []int{0}
}
...
func (*ProposeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a266eca16a42cbe, []int{1}
}
...
func (*SafetyParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a266eca16a42cbe, []int{2}
}
...
func init() { proto.RegisterFile("nemo_network/bridge/params.proto", fileDescriptor_8a266eca16a42cbe) }

var fileDescriptor_8a266eca16a42cbe = []byte{
	// 448 bytes of a gzipped FileDescriptorProto
	,
}
