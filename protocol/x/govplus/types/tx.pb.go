...
// source: nemo-network/govplus/tx.proto
...
type MsgSlashValidator struct {
	...
	// this.
	TokensAtInfractionHeight github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=tokens_at_infraction_height,json=tokensAtInfractionHeight,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"tokens_at_infraction_height"`
