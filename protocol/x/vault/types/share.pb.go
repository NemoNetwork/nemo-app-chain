...
// source: nemo-network/vault/share.proto
...
type NumShares struct {
	// Number of shares.
	NumShares github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=num_shares,json=numShares,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"num_shares"`
}
...
func init() {
	...
	proto.RegisterType((*OwnerShareUnlocks)(nil), "nemo-network.vault.OwnerShareUnlocks")
	proto.RegisterType((*ShareUnlock)(nil), "nemo-network.vault.ShareUnlock")
}

func init() { proto.RegisterFile("nemo-network/vault/share.proto", fileDescriptor_b65bab3182bbf56c) }
