...
// source: nemo-network/vault/tx.proto
...
type MsgDepositToVault struct {
	...
	QuoteQuantums github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=quote_quantums,json=quoteQuantums,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"quote_quantums"`
}
