...
// source: nemo-network/ratelimit/limit_params.proto
...
type Limiter struct {
	...
	BaselineMinimum github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=baseline_minimum,json=baselineMinimum,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"baseline_minimum"`
