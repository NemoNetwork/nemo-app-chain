...
//	  Ex1: unemo sent back to dYdX chain from Osmosis
//	       Packet Denom:      transfer/channel-X/unemo
//	        -> Remove Prefix: unemo
//	        -> Leave as is:   unemo
//
