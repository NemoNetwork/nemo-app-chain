...
// source: nemo-network/affiliates/affiliates.proto
...
func init() {
	proto.RegisterType((*AffiliateTiers)(nil), "nemo-network.affiliates.AffiliateTiers")
	proto.RegisterType((*AffiliateTiers_Tier)(nil), "nemo-network.affiliates.AffiliateTiers.Tier")
}

func init() {
	proto.RegisterFile("nemo-network/affiliates/affiliates.proto", fileDescriptor_7de5ba9c426e9350)
}
