...
// source: nemo-network/affiliates/query.proto
...
type AffiliateInfoResponse struct {
	...
	ReferredVolume github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=referred_volume,json=referredVolume,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"referred_volume"`
	// The affiliate's currently staked native tokens (in whole coins).
	StakedAmount github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=staked_amount,json=stakedAmount,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"staked_amount"`
}
...
func init() {
	proto.RegisterType((*AffiliateInfoRequest)(nil), "nemo-network.affiliates.AffiliateInfoRequest")
	proto.RegisterType((*AffiliateInfoResponse)(nil), "nemo-network.affiliates.AffiliateInfoResponse")
	proto.RegisterType((*ReferredByRequest)(nil), "nemo-network.affiliates.ReferredByRequest")
	proto.RegisterType((*ReferredByResponse)(nil), "nemo-network.affiliates.ReferredByResponse")
	proto.RegisterType((*AllAffiliateTiersRequest)(nil), "nemo-network.affiliates.AllAffiliateTiersRequest")
	proto.RegisterType((*AllAffiliateTiersResponse)(nil), "nemo-network.affiliates.AllAffiliateTiersResponse")
}

func init() {
	proto.RegisterFile("nemo-network/affiliates/query.proto", fileDescriptor_2edc1b3ea39b05a9)
}
...
func (c *queryClient) AffiliateInfo(ctx context.Context, in *AffiliateInfoRequest, opts ...grpc.CallOption) (*AffiliateInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.affiliates.Query/AffiliateInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ReferredBy(ctx context.Context, in *ReferredByRequest, opts ...grpc.CallOption) (*ReferredByResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.affiliates.Query/ReferredBy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AllAffiliateTiers(ctx context.Context, in *AllAffiliateTiersRequest, opts ...grpc.CallOption) (*AllAffiliateTiersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.affiliates.Query/AllAffiliateTiers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_AffiliateInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.affiliates.Query/AffiliateInfo",
	}
...
func _Query_ReferredBy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.affiliates.Query/ReferredBy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AllAffiliateTiers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.affiliates.Query/AllAffiliateTiers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nemo-network.affiliates.Query",
	...
	Metadata: "nemo-network/affiliates/query.proto",
}
