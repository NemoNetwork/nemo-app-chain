...
// source: nemo-network/affiliates/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegisterAffiliate)(nil), "nemo-network.affiliates.MsgRegisterAffiliate")
	proto.RegisterType((*MsgRegisterAffiliateResponse)(nil), "nemo-network.affiliates.MsgRegisterAffiliateResponse")
	proto.RegisterType((*MsgUpdateAffiliateTiers)(nil), "nemo-network.affiliates.MsgUpdateAffiliateTiers")
	proto.RegisterType((*MsgUpdateAffiliateTiersResponse)(nil), "nemo-network.affiliates.MsgUpdateAffiliateTiersResponse")
}

func init() { proto.RegisterFile("nemo-network/affiliates/tx.proto", fileDescriptor_41c2f092a0ec6d7f) }
...
func (c *msgClient) RegisterAffiliate(ctx context.Context, in *MsgRegisterAffiliate, opts ...grpc.CallOption) (*MsgRegisterAffiliateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.affiliates.Msg/RegisterAffiliate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateAffiliateTiers(ctx context.Context, in *MsgUpdateAffiliateTiers, opts ...grpc.CallOption) (*MsgUpdateAffiliateTiersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nemo-network.affiliates.Msg/UpdateAffiliateTiers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterAffiliate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.affiliates.Msg/RegisterAffiliate",
	}
...
func _Msg_UpdateAffiliateTiers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nemo-network.affiliates.Msg/UpdateAffiliateTiers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "nemo-network.affiliates.Msg",
	...
	Metadata: "nemo-network/affiliates/tx.proto",
}
