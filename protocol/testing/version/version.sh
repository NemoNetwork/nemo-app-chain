...
version_to_url["$PREUPGRADE_VERSION"]="https://github.com/nemo-network/v4-chain/releases/download/protocol%2F$PREUPGRADE_VERSION_FULL_NAME/nemo-networkd-$PREUPGRADE_VERSION_FULL_NAME-linux-amd64.tar.gz"
