...
// source: nemo_network/indexer/indexer_manager/event.proto
...
func (IndexerTendermintEvent_BlockEvent) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7a51dce0e32ec84f, []int{2, 0}
}
...
func (*IndexerTendermintEventWrapper) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a51dce0e32ec84f, []int{0}
}
...
func (*IndexerEventsStoreValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a51dce0e32ec84f, []int{1}
}
...
func (*IndexerTendermintEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a51dce0e32ec84f, []int{2}
}
...
func (*IndexerTendermintBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_7a51dce0e32ec84f, []int{3}
}
...
func init() {
	proto.RegisterFile("nemo_network/indexer/indexer_manager/event.proto", fileDescriptor_7a51dce0e32ec84f)
}

var fileDescriptor_7a51dce0e32ec84f = []byte{
	// 604 bytes of a gzipped FileDescriptorProto
	,
}
