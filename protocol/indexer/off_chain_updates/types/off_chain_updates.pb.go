...
type OrderPlaceV1 struct {
	...
	PlacementStatus OrderPlaceV1_OrderPlacementStatus `protobuf:"varint,2,opt,name=placement_status,json=placementStatus,proto3,enum=nemo-network.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus" json:"placement_status,omitempty"`
...
type OrderRemoveV1 struct {
	...
	Reason         types2.OrderRemovalReason        `protobuf:"varint,2,opt,name=reason,proto3,enum=nemo-network.indexer.shared.OrderRemovalReason" json:"reason,omitempty"`
	RemovalStatus  OrderRemoveV1_OrderRemovalStatus `protobuf:"varint,3,opt,name=removal_status,json=removalStatus,proto3,enum=nemo-network.indexer.off_chain_updates.OrderRemoveV1_OrderRemovalStatus" json:"removal_status,omitempty"`
...
type OrderReplaceV1 struct {
	...
	PlacementStatus OrderPlaceV1_OrderPlacementStatus `protobuf:"varint,3,opt,name=placement_status,json=placementStatus,proto3,enum=nemo-network.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus" json:"placement_status,omitempty"`
	TimeStamp       *time.Time                        `protobuf:"bytes,4,opt,name=time_stamp,json=timeStamp,proto3,stdtime" json:"time_stamp,omitempty"`
}
...
func init() {
	proto.RegisterEnum("nemo-network.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus", OrderPlaceV1_OrderPlacementStatus_name, OrderPlaceV1_OrderPlacementStatus_value)
	proto.RegisterEnum("nemo-network.indexer.off_chain_updates.OrderRemoveV1_OrderRemovalStatus", OrderRemoveV1_OrderRemovalStatus_name, OrderRemoveV1_OrderRemovalStatus_value)
	proto.RegisterType((*OrderPlaceV1)(nil), "nemo-network.indexer.off_chain_updates.OrderPlaceV1")
	proto.RegisterType((*OrderRemoveV1)(nil), "nemo-network.indexer.off_chain_updates.OrderRemoveV1")
	proto.RegisterType((*OrderUpdateV1)(nil), "nemo-network.indexer.off_chain_updates.OrderUpdateV1")
	proto.RegisterType((*OrderReplaceV1)(nil), "nemo-network.indexer.off_chain_updates.OrderReplaceV1")
	proto.RegisterType((*OffChainUpdateV1)(nil), "nemo-network.indexer.off_chain_updates.OffChainUpdateV1")
}
