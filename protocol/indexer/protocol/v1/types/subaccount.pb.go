...
// source: nemo-network/indexer/protocol/v1/subaccount.proto
...
type IndexerPerpetualPosition struct {
	...
	Quantums github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=quantums,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"quantums"`
	...
	FundingPayment github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"funding_payment"`
}
