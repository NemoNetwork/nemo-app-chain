...
type OpenInterestUpdate struct {
	...
	OpenInterest github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=open_interest,json=openInterest,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"open_interest"`
}
...
func init() {
	...
	proto.RegisterType((*RegisterAffiliateEventV1)(nil), "nemo-network.indexer.events.RegisterAffiliateEventV1")
}
