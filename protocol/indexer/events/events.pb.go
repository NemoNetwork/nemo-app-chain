...
// source: nemo-network/indexer/events/events.proto
...
type FundingUpdateV1 struct {
	...
	FundingIndex github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"funding_index"`
}
...
type AddressTradingReward struct {
	...
	DenomAmount github_com_nemo-network_v4_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=denom_amount,json=denomAmount,proto3,customtype=github.com/nemo-network/v4-chain/protocol/dtypes.SerializableInt" json:"denom_amount"`
}
