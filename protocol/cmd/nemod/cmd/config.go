...
const (
	...
	// TODO(GENESIS): `unemo` is a placeholder for the stake token of the dYdX chain.
	// Before this software is published for genesis, `unemo` should be replaced with
	...
	minGasPriceStakeToken = "25000000000unemo"
